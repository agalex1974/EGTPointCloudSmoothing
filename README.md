...
consequence also <a href="https://www.boost.org/">BOOST</a>. It is highly advisable
to install CGAL and BOOST in your "C:\Program FIles\" directory as CMAKE searches 
this directory by default to find this software. We will describe the process to compile
the software in Windows using the VISUAL STUDIO 2019 and onwards tools.</i></p> 
...
<p><b>Execution</b></p>
If a binary executable is successfully built, for example EGTSmoothingVS2019.exe, the program is run as:<br />
<br />
